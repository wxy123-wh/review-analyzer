...
import com.wh.review.backend.persistence.ReviewQueryRepository;
import com.wh.review.backend.persistence.ReviewQueryRepository.ReviewRecord;
...
public class ReviewAggregationService {
    ...
    public static final String DEFAULT_PRODUCT_CODE = "jd-100127936932";
    public static final String DEFAULT_COMPARE_PRODUCT_CODE = "jd-competitor";
    ...
    public ReviewAggregationService(ReviewQueryRepository reviewQueryRepository) {
    ...
    public List<AggregatedReview> loadReviews(String productCode) {
        ...
        List<ReviewRecord> records = reviewQueryRepository.findByProductCode(normalizedProductCode);
